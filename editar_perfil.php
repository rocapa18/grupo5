        ...
        <div class="contenedor">
          <div class="animation">
            ...
            <div class="textoperfil">
                ...
                <span><?php echo "Usuario: " . $usuarioLogueado; ?></span><br><span>
                <span>Nombre:<input type="text" placeholder="Indique nuevo nombre"></span><br><span>
                <span><?php echo "Estado:  ACTIVO - " . date("d/m/Y"); ?></span><br>
                <form action="editar_perfil.php" method="POST">
                    <br>
                    <button type="submit" class="btn btn-warning mb-2 boton-submit">Guardar
                    </button>                    
                </form>
            </div>
        </div>
